...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer(' ˆ°• ᴡᴀʟᴅʏ ᴡʀɪᴛɪɴɢꜱ •°ˆ ')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔎 Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ 🔍', url='https://t.me/+gp3Rd_is-Ig0OGE1')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('😪 Join My Channel 💢', url='https://t.me/waldy_Writings')
        ], [
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ 📟', callback_data='contact')
        ], [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
    ...
    await query.answer(' ˆ°• ᴡᴀʟᴅʏ ᴡʀɪᴛɪɴɢꜱ •°ˆ ')
